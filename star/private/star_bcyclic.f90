...
! J. Computational Physics, 229 (2010) 6392-6404.
      ...
      logical, parameter :: blas3_dgemm3 = .true.
...
!     $                   WORK, IWORK, INFO )
   ...
   subroutine my_gemm3_0_p1(m,n,k,a,b,c) ! c := a*b
      ...
      !call dgemm3('N', 'N', m, n, k, 0d0, a, n, b, n, 1d0, c, n)     ! this cannot be right since does nothing.     but is????
   ...
   subroutine my_gemm3_plus_mm(m,n,k,a,b,d,e,c) ! c := c + a*b + d*e
      ...
      call my_gemm3_0_p1(m,n,k,a,b,c) ! c = a*b
